...
func on_player_entra_cuarto_nuevo_delete() -> void:
	delete_previous_room()

func on_player_entra_cuarto_nuevo_cerrar_barrera(barrera_entrada: TileMapLayer) -> void:
	barrera_entrada.enabled = cerrar_barrera
...
func delete_previous_room() -> void:
	if room_previous and is_instance_valid(room_previous):
		...
		print("No hay room anterior válida para borrar")
